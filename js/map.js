...
// Создаем массив объектов с рандомными данными объявлений
const similarOffers = createOffers();

// Генерация разметки popup'а
...
// Создаем каждому офферу маркер, маркер вешаем на карту и на него вешаем popup
